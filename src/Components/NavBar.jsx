...
export default function NavBar(props) {
    ...
    function CloseMenuSlider(event) { 
        ...
        if (
          ...
          event.target.classList.contains('resume_crete_button-mobile') ||
          event.target.classList.contains('LoginButton-mobile') ||
          event.target.classList.contains('list') ||
          (li && event.target.contains(li))
        ) {
  ...
  return (
    ...
    <section className="sec-1">
        ...
        <div className="openMenuSlider" onClick={CloseMenuSlider}>
            <div className="slideBody">

                    <div className="user_click_button_mobile">
                     <Link to="/FormResume"> <div className="resume_crete_button-mobile"  onClick={CloseMenuSlider} >Create Your Resume</div></Link>
                        <div className="LoginButton-mobile"  onClick={CloseMenuSlider}>Login</div>
                    </div>
                    <div className="nav_links_mobile">
                            <ul>
                         <Link to="/"><li className='list' onClick={CloseMenuSlider} >Home</li></Link>
                                <li className='list' onClick={CloseMenuSlider}>Templates</li>
                                <li className='list' onClick={CloseMenuSlider}>Examples</li>
                                <li className='list' onClick={CloseMenuSlider}>About</li>
                                <li className='list' onClick={CloseMenuSlider}>Help</li>
                            </ul>
                    </div>
