    ...
    <div className="Section-02">
      ...
      <div className="blockOfSqures">
          ...
          <svg width="1429" height="475" viewBox="0 0 1429 475" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <svg width="390" height="391" viewBox="0 0 390 391" fill="none" xmlns="http://www.w3.org/2000/svg">
          <rect x="80.7747" width="36.5913" height="139.365" rx="9.54556" transform="rotate(35.4217 80.7747 0)" fill="url(#paint0_diamond_319_36)"/>
          <rect x="169.19" y="45.2575" width="47.0701" height="163.176" rx="12.552" transform="rotate(41.0927 169.19 45.2575)" fill="url(#paint1_diamond_319_36)"/>
          <rect x="315.082" y="189.503" width="47.0701" height="163.176" rx="12.552" transform="rotate(55.3891 315.082 189.503)" fill="url(#paint2_diamond_319_36)"/>
          <rect x="244.156" y="100.841" width="42.648" height="162.433" rx="11.1256" transform="rotate(42.3704 244.156 100.841)" fill="url(#paint3_diamond_319_36)"/>
          <rect x="375.533" y="296" width="43.4111" height="165.34" rx="11.3246" transform="rotate(71.2151 375.533 296)" fill="url(#paint4_diamond_319_36)"/>
          <defs>
          <radialGradient id="paint0_diamond_319_36" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(111.582 79.7797) rotate(133.61) scale(93.658 196.853)">
          <stop stopColor="#FFD401" stopOpacity="0"/>
          <stop offset="0.603633" stopColor="#3C2DF5"/>
          <stop offset="0.674602" stopColor="#3C2DF5"/>
          </radialGradient>
          <radialGradient id="paint1_diamond_319_36" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(208.819 138.668) rotate(-88.4705) scale(155.345 152.634)">
          <stop stopColor="#FFD401"/>
          <stop offset="1" stopColor="#FFD401" stopOpacity="0"/>
          </radialGradient>
          <radialGradient id="paint2_diamond_319_36" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(354.712 282.914) rotate(-88.4705) scale(155.345 152.634)">
          <stop stopColor="#FFD401"/>
          <stop offset="1" stopColor="#FFD401" stopOpacity="0"/>
          </radialGradient>
          <radialGradient id="paint3_diamond_319_36" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(280.062 193.826) rotate(-43.593) scale(112.646 236.763)">
          <stop stopColor="#FFD401" stopOpacity="0"/>
          <stop offset="0.603633" stopColor="#3C2DF5"/>
          <stop offset="0.674602" stopColor="#3C2DF5"/>
          </radialGradient>
          <radialGradient id="paint4_diamond_319_36" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(412.082 390.649) rotate(-70.1135) scale(190.353 400.089)">
          <stop stopColor="#3C2DF5"/>
          <stop offset="0.307129" stopColor="#FFD401" stopOpacity="0"/>
          <stop offset="0.484513" stopColor="#3C2DF5"/>
          </radialGradient>
